...
###
## Change string to output from metadata.json 
## Example:  jq -r .infraID <installation_directory>/metadata.json
###
...
# Change "VM Network to your network if it is different"
